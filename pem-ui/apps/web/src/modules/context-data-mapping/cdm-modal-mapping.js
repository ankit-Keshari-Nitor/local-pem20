    ...
    return (
        <>
            <Shell.Page name="context-mapping" id="context-mapping" className="context-mapping">
                <Shell.PageHeader
                    title={pageUtil.t('mod-context-properties:request')}
                        ...
                        <Panel minSize={40} defaultSize={70} maxSize={80}>
                            <Column lg={12} md={12}>
                                {(!page.ui.selectedNode || typeof page.ui.selectedNode.value.value === 'object') ? (
                                    ...
                                    <CDMTreeView key={page.ui.selectedNode?.id} config={pageConfig.rdpTreeView} data={page.model.mappingdata} onSelect={page.uiOnSelectJPath} selected={page.ui.selectedNode} />
                                }
                            </Column>
                        </Panel>
                    </PanelGroup>
