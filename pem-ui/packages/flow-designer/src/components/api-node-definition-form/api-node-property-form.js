...
import { Modal, TextInput, Checkbox, Button, TableContainer, Table, Select, SelectItem, FileUploaderItem, TextArea, TableHead, TableRow, TableHeader, TableBody, TableCell, TableSelectRow, Column, Grid, Layer } from '@carbon/react';

import './api-node-definition-form.scss';
import { VectorIcon } from '../../icons';;
import { requestMethods, inputOutputFormats } from '../../constants';

export default function APINodePropertyForm({ formState, apiConfigData, handlePropertyFormChange, readOnly, errors, apiConfigUrl, toggleHeaders, showHeaders, headerError, showCode, showCodeHandle, file, onOpenFiles, onDeleteFile, handleSaveForm, openCancelDialog, openContextMappingModal, selectedHeaders, handleAddHeader, headers, handleRowSelect, handleSelectAll, handleRemoveSelected, handleHeaderInputChange, setOpenContextMappingModal }) {
    ...
    return (
        <div>
            ...
            <Grid className="tab-panel-grid">
                ...
                {errors.propertyForm.url && <Column lg={16}><div className="error-message">{errors.propertyForm.url}</div></Column>}
                {/* Request Method */}
                <Column lg={8}>
                    <Select
                        disabled={readOnly}
